...
{#key themeChange}
	<svg
		...
		/><rect x="87.60911" y="237" width="250" height="86" fill="#3f3d56" /><rect
			...
			height="86"
			fill="#3f3d56"
		/><rect x="271.60911" y="150" width="16" height="16" fill={primary} opacity="0.4" /><rect
			x="294.60911"
			y="150"
			width="16"
			height="16"
			fill={primary}
			opacity="0.8"
		/><rect x="317.60911" y="150" width="16" height="16" fill={primary} /><rect
			x="271.60911"
			y="251"
			width="16"
			height="16"
			fill={primary}
			opacity="0.4"
		/><rect x="294.60911" y="251" width="16" height="16" fill={primary} opacity="0.8" /><rect
			x="317.60911"
			y="251"
			width="16"
			height="16"
			fill={primary}
		/><rect x="271.60911" y="352" width="16" height="16" fill={primary} opacity="0.4" /><rect
			x="294.60911"
			y="352"
			width="16"
			height="16"
			fill={primary}
			opacity="0.8"
		/><rect x="317.60911" y="352" width="16" height="16" fill={primary} /><circle
			cx="316.60911"
			cy="538"
			r="79"
			fill="#2f2e41"
